...
public class EntryDateBlock extends FrameLayout implements DatePickerDialog.OnDateSetListener, FormEntry {
    ...
    private void init() {
        ...
        mLabelTextView = (TextView) findViewById(R.id.entry_date_label);
        mDayOfMonth = (TextView) findViewById(R.id.entry_date_day_of_month);
        mDayOfWeek = (TextView) findViewById(R.id.entry_date_day_of_week);
        mMonth = (TextView) findViewById(R.id.entry_date_month);
