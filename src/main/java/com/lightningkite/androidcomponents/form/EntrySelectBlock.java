...
public class EntrySelectBlock extends FrameLayout implements FormEntry {
    ...
    private void init() {
        ...
        mLabelTextView = (TextView) findViewById(R.id.entry_select_label);
        mTextView = (TextView) findViewById(R.id.entry_select_text);
        mIconView = (ImageView) findViewById(R.id.entry_select_icon);
